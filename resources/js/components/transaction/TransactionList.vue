    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                ...
                <input v-model="search" type="number" v-on:keyup="getData" class="form-input col-12 m-2">
                <div class="card">
                    <div class="m-2">
                    ...
                    <table class="table table-bordered text-center">
                        ...
                        <tr v-for="transaction in transactions">
                            ...
                            <td v-if="role==='admin'">
                                <router-link :to="{ name: 'transactionEdit', 'params': {'transactionId':transaction.id} }">
                                <button class="btn btn-primary">Edit</button>
                                </router-link>
                                <button @click="deleteTransaction(transaction.id)" class="btn btn-primary">Delete</button></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      getData(){
        axios.get(`/api/transaction?search=${this.search * 100}`).then((response) => {
